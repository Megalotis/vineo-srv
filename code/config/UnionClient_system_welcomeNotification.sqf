...
"<t size='1.2'>Добро пожаловать на сервер Vineo, <t color='#f5be00'>%1</t></t>
<br /><br />Не забудьте изучить правила на нашем форуме <t underline='true' color='#1dae0e'>vineo.life/forum</t>
<br /><br />Всю необходимую информацию по подключению, управлению и донату вы можете получить на нашем сайте: <t underline='true' color='#1dae0e'>vineo.life</t>
...
private _role1names = ["Vineo Life v2.0"];
private _role2 = "Администрация";
private _role2names = ["Megalotis", "Sherdan", "GHOST", "Huan de Шершень"];
private _role3 = "Разработка";
private _role3names = ["Megalotis"];
private _role4 = "Сайт";
private _role4names = ["vineo.life"];
private _role5 = "Форум";
private _role5names = ["forum.vineo.life"];
private _role6 = "TeamSpeak3 сервер";
private _role6names = ["vineo.life"];
