...
_query = format ["INSERT INTO players (playerid, name, cash, bankacc, cop_licenses, med_licenses, civ_licenses, reb_licenses, gear, config, indicators, recipes, servermap) VALUES('%1', '%2', '0', '100000','""[]""','""[]""','%4','%5','""[]""','""[]""','""[]""','""[]""','%3')",
    _uid,
    _name,
    worldName,
    _Civarray,
