...

{
    ...
    ["life_eastGangId", 2],
    //TASKFORCE
    ["tf_radio_server_name", "Vineo"],
    ["tf_radio_channel_name", "LifeRadio"],
    ["tf_radio_channel_password", "12321"],
	//Gov
	["server_creditTax",0],
...
TON_fnc_getRealTime = {
   ...
   format ["Vineo Altis Life  [%4:%5 %3-%2-%1]",_time select 0 call TON_fnc_doubledigits,_time select 1 call TON_fnc_doubledigits,_time select 2 call TON_fnc_doubledigits,_time select 3 call TON_fnc_doubledigits,_time select 4 call TON_fnc_doubledigits]
};
TON_fnc_addTime = {
