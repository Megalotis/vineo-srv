...
*/
	player createDiaryRecord["changelog",
		[
			"Новости Сервера",
				"Следите за новостями на нашем сайте: Vineo.life<br/>"
		]
	...
	player createDiaryRecord["prices",
		[
			"Цены на Ресурсы",
				"Текущие цены и легальность ресурсов вы можете посмотреть через меню игрока (Y)"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Правила острова",
				"Внимательно изучите правила острова на форуме Vineo.life<br/><br/>Незнание правил не освобождает от ответственности!"
		]
	];
